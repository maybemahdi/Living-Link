  ...
  return (
    <div>
      ...
      <div className="my-10">
        ...
        >
          <div data-aos="fade-left" className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-slate-200 dark:text-gray-800">
          ...
          <div data-aos="fade-up" className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-slate-200 dark:text-gray-800">
            <div className="flex justify-between p-4">
              <div className="flex space-x-4">
                <div>
                  <img
                ...
                <div>
                  <h4 className="font-bold">Tahsin Hasan</h4>
          ...
          <div data-aos="fade-right"  className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-slate-200 dark:text-gray-800">
            <div className="flex justify-between p-4">
              <div className="flex space-x-4">
                <div>
                  <img
